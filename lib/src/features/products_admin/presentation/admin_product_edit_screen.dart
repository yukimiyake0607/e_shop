...
import 'package:e_shop/src/common_widgets/responsive_two_column_layout.dart';
...
import 'package:e_shop/src/features/products_admin/presentation/admin_product_edit_controller.dart';
import 'package:e_shop/src/features/products_admin/presentation/product_validator.dart';
...
class EditProductOptions extends StatelessWidget {
  const EditProductOptions({
    super.key,
    required this.onLoadFromTemplate,
